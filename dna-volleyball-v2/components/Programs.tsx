...
export default function Programs() {
  ...
  <p className="text-sm leading-7 text-gray-500">
    Pricing starts at <span className="font-semibold text-gray-300">$30 per athlete / session</span>.
    Session availability, locations, and registration are managed through our
    official Communiti page. Pricing may vary for specialty clinics or events.
  </p>
